...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='D:/IPR1/Bayesian-Crowd-Counting/UCRF/UCF-QNRF_ECCV18')
    parser.add_argument('--data-dir', default='D:/IPR1/Bayesian-Crowd-Counting/UCRF/UCF-QNRF_ECCV18/PostProcessed')
